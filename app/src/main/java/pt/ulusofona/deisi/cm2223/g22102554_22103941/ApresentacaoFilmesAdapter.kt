...
class ApresentacaoFilmesAdapter(private val onOperationClick: (Filme) -> Unit, private var items: List<Filme> = listOf()) : RecyclerView.Adapter<ApresentacaoFilmesAdapter.HistoryViewHolder>() {
    ...
    override fun onBindViewHolder(holder: HistoryViewHolder, position: Int) {
        ...
        holder.binding.filme.text = items[position].nome
